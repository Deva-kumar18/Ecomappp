...
},
{
    ...
    specs: {
        ...
        weight: "500 grams",
        additionalFeatures: "Built-in microphone for hands-free calls, LED indicators",
      },
},{
    id:14,
    title:"speaker-2",
...
export const cartSlice = createSlice({
    ...
    reducers:{
        cart(state,action){
            const {key,opr,count} =action.payload
           
          if(opr==="add"){
            state.cart[key].count=count+state.cart[key].count
...
export const { cart,removeCart,updateCart,filter } = cartSlice.actions;
